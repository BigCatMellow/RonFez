...
- Zito
- UCB Fred
- additional interns by season/year

## Explicit fictional/constructed characters

These should eventually receive separate files under a `characters/` folder rather than being mixed with real-person biographies.

Known examples discussed so far:

- Iris — voiced by Ron Bennington
- Kenny Allen — voiced by Miles Bennington
- Jan Brady — Fez
- André the Giant — Fez
- Mr. Rogers — Giant Brian Carothers
- D-Man — Fez late-era character/device
- Inner Voice Fez — late-era theatricalized self-critical voice
- East Side Dave's many characters, including Guy Guyerson and Midnight Rider material
